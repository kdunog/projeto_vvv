...
pontoVendaService.salvar(pontoVenda));
        assertEquals("Ponto de venda deve possuir endereço válido.", 
...
when(pontoVendaRepository.save(any(PontoVenda.class))).thenAnswer(invocation -> 
