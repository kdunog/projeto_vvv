...
class TicketServiceTest {
    ...
    void deveLancarExcecaoReservaNaoConfirmada() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> ticketService.emitirTicket(1L));

        assertEquals("Pagamento deve estar confirmado para emissão do ticket.", exception.getMessage());
    ...
    void deveLancarExcecaoSemPagamento() {
        ...
        assertEquals("Reserva não possui pagamento associado.", exception.getMessage());
        verify(ticketRepository, never()).save(any());
    }
    ...
    void deveLancarExcecaoTicketJaEmitido() {
        ...
        assertEquals("Esta reserva já possui ticket emitido.", exception.getMessage());
        verify(ticketRepository, never()).save(any());
    }
}